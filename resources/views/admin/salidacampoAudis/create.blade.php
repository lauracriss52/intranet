        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.create') }} {{ trans('cruds.salidacampoAudi.title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.salidacampo-audis.store") }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group {{ $errors->has('vueloporti') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="vueloporti" id="vueloporti" value="1" {{ old('vueloporti', 0) == 1 ? 'checked' : '' }}>
