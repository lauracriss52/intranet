        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.create') }} {{ trans('cruds.contactoDeEmergencium.title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.contacto-de-emergencia.store") }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group {{ $errors->has('relacion') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="relacion" id="relacion" value="{{ old('relacion', '') }}" required>
