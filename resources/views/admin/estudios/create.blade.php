                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.estudios.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('titulo_adquirido') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="titulo_adquirido" id="titulo_adquirido" value="{{ old('titulo_adquirido', '') }}" required>
                        ...
                        <div class="form-group {{ $errors->has('fecha_de_terminacion') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="fecha_de_terminacion" id="fecha_de_terminacion" value="{{ old('fecha_de_terminacion') }}" required>
                        ...
                        <div class="form-group {{ $errors->has('nivel_educativo') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control" name="nivel_educativo" id="nivel_educativo" required>
                                ...
                                @foreach(App\Models\Estudio::NIVEL_EDUCATIVO_SELECT as $key => $label)
                                    <option value="{{ $key }}" {{ old('nivel_educativo', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
