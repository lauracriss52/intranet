        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.edit') }} {{ trans('cruds.ingesosGeopark.title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.ingesos-geoparks.update", [$ingesosGeopark->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group {{ $errors->has('gestionar_documentos') ? 'has-error' : '' }}">
                            <div>
                                <input type="hidden" name="gestionar_documentos" value="0">
                                <input type="checkbox" name="gestionar_documentos" id="gestionar_documentos" value="1" {{ $ingesosGeopark->gestionar_documentos || old('gestionar_documentos', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('requerimiento_hse') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="requerimiento_hse" id="requerimiento_hse" value="1" {{ $ingesosGeopark->requerimiento_hse || old('requerimiento_hse', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('diligenciar_formatos') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="diligenciar_formatos" id="diligenciar_formatos" value="1" {{ $ingesosGeopark->diligenciar_formatos || old('diligenciar_formatos', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('enviar_documentacion_hse') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="enviar_documentacion_hse" id="enviar_documentacion_hse" value="1" {{ $ingesosGeopark->enviar_documentacion_hse || old('enviar_documentacion_hse', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('solicitar_induccion') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="solicitar_induccion" id="solicitar_induccion" value="1" {{ $ingesosGeopark->solicitar_induccion || old('solicitar_induccion', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('transporte_1') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="transporte_1" id="transporte_1" value="1" {{ $ingesosGeopark->transporte_1 || old('transporte_1', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('transporte_2') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="transporte_2" id="transporte_2" value="1" {{ $ingesosGeopark->transporte_2 || old('transporte_2', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('hospedaje_1') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="hospedaje_1" id="hospedaje_1" value="1" {{ $ingesosGeopark->hospedaje_1 || old('hospedaje_1', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('hospedaje_villanueva') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="hospedaje_villanueva" id="hospedaje_villanueva" value="1" {{ $ingesosGeopark->hospedaje_villanueva || old('hospedaje_villanueva', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('viaticos') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="viaticos" id="viaticos" value="1" {{ $ingesosGeopark->viaticos || old('viaticos', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('notificacion_salida') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="notificacion_salida" id="notificacion_salida" value="1" {{ $ingesosGeopark->notificacion_salida || old('notificacion_salida', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('transporte_villanueva_bogota') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="transporte_villanueva_bogota" id="transporte_villanueva_bogota" value="1" {{ $ingesosGeopark->transporte_villanueva_bogota || old('transporte_villanueva_bogota', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('hospedaje_bogota') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="hospedaje_bogota" id="hospedaje_bogota" value="1" {{ $ingesosGeopark->hospedaje_bogota || old('hospedaje_bogota', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('hospedaje_villanueva_salida') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="hospedaje_villanueva_salida" id="hospedaje_villanueva_salida" value="1" {{ $ingesosGeopark->hospedaje_villanueva_salida || old('hospedaje_villanueva_salida', 0) === 1 ? 'checked' : '' }}>
