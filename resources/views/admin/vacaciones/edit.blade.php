        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.edit') }} {{ trans('cruds.vacacione.title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.vacaciones.update", [$vacacione->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group {{ $errors->has('fecha_de_inicio') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="fecha_de_inicio" id="fecha_de_inicio" value="{{ old('fecha_de_inicio', $vacacione->fecha_de_inicio) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('fecha_de_finalizacion') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="fecha_de_finalizacion" id="fecha_de_finalizacion" value="{{ old('fecha_de_finalizacion', $vacacione->fecha_de_finalizacion) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('reintegro') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="reintegro" id="reintegro" value="{{ old('reintegro', $vacacione->reintegro) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('dias') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="dias" id="dias" value="{{ old('dias', $vacacione->dias) }}" step="0.1" required max="15">
                            @if($errors->has('dias'))
                        ...
                        <div class="form-group {{ $errors->has('aprobadas') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="aprobadas" id="aprobadas" value="1" {{ $vacacione->aprobadas || old('aprobadas', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('perdio_de_vacaciones_que_disfruta') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="perdio_de_vacaciones_que_disfruta" id="perdio_de_vacaciones_que_disfruta" value="{{ old('perdio_de_vacaciones_que_disfruta', $vacacione->perdio_de_vacaciones_que_disfruta) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('empleado') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control select2" name="empleado_id" id="empleado_id" required>
                                @foreach($empleados as $id => $entry)
                                    <option value="{{ $id }}" {{ (old('empleado_id') ? old('empleado_id') : $vacacione->empleado->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{ $errors->has('dias_pendientes') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="dias_pendientes" id="dias_pendientes" value="{{ old('dias_pendientes', $vacacione->dias_pendientes) }}" step="0.01">
