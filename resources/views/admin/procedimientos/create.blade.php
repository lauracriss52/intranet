        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.create') }} {{ trans('cruds.procedimiento.title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.procedimientos.store") }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group {{ $errors->has('fecha_de_creacion') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="fecha_de_creacion" id="fecha_de_creacion" value="{{ old('fecha_de_creacion') }}" required>
                        ...
                        <div class="form-group {{ $errors->has('fecha_actualizacion') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="fecha_actualizacion" id="fecha_actualizacion" value="{{ old('fecha_actualizacion') }}" required>
                        ...
                        <div class="form-group {{ $errors->has('nota_del_procedimiento') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control ckeditor" name="nota_del_procedimiento" id="nota_del_procedimiento">{!! old('nota_del_procedimiento') !!}</textarea>
