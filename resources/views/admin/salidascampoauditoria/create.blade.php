        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.create') }} {{ trans('cruds.salidascampoauditorium.title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.salidascampoauditoria.store") }}" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group {{ $errors->has('solicitud') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control select2" name="solicitud_id" id="solicitud_id">
                                @foreach($solicituds as $id => $entry)
                                    <option value="{{ $id }}" {{ old('solicitud_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{ $errors->has('solicitud_de_transporte') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="solicitud_de_transporte" id="solicitud_de_transporte" value="1" {{ old('solicitud_de_transporte', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('vuelo') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="vuelo" id="vuelo" value="1" {{ old('vuelo', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('formulario_edica') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="formulario_edica" id="formulario_edica" value="1" {{ old('formulario_edica', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('covid') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="covid" id="covid" value="1" {{ old('covid', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('induccion_campo') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="induccion_campo" id="induccion_campo" value="1" {{ old('induccion_campo', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('estado') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="estado" id="estado" value="1" {{ old('estado', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('matriz') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="matriz" id="matriz" value="1" {{ old('matriz', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('excel') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="excel" id="excel" value="1" {{ old('excel', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('informar') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="informar" id="informar" value="1" {{ old('informar', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('ods') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="ods" id="ods" value="1" {{ old('ods', 0) == 1 ? 'checked' : '' }}>
