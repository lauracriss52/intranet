            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="table-responsive">
                        <table class=" table table-bordered table-striped table-hover datatable datatable-Actaentrega">
                            <thead>
                                <tr>
                                    <th width="10">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select class="search">
                                            ...
                                            @foreach($tipoentregas as $key => $item)
                                    ...
                                    <td>
                                        <select class="search" strict="true">
                                            <option value>{{ trans('global.all') }}</option>
                                            @foreach(App\Models\Actaentrega::MODALIDAD_RADIO as $key => $item)
...
@endcan
  ...
  let table = $('.datatable-Actaentrega:not(.ajaxTable)').DataTable({ buttons: dtButtons })
