        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.create') }} {{ trans('cruds.experienciaLaboral.title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.experiencia-laborals.store") }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group {{ $errors->has('correo_telefono') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="correo_telefono" id="correo_telefono" value="{{ old('correo_telefono', '') }}" required>
                        ...
                        <div class="form-group {{ $errors->has('ubicacion') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="ubicacion" id="ubicacion" value="{{ old('ubicacion', '') }}" required>
                        ...
                        <div class="form-group {{ $errors->has('cargo_desempenado') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="cargo_desempenado" id="cargo_desempenado" value="{{ old('cargo_desempenado', '') }}" required>
                        ...
                        <div class="form-group {{ $errors->has('tareas') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="tareas" id="tareas" value="{{ old('tareas', '') }}" required>
