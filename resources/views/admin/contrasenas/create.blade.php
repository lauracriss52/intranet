        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.create') }} {{ trans('cruds.contrasena.title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.contrasenas.store") }}" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group {{ $errors->has('usuario') ? 'has-error' : '' }}">
                            <label class="required" for="usuario">{{ trans('cruds.contrasena.fields.usuario') }}</label>
                            <input class="form-control" type="text" name="usuario" id="usuario" value="{{ old('usuario', '') }}" required>
                        ...
                        <div class="form-group {{ $errors->has('contrasena') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="contrasena" id="contrasena" value="{{ old('contrasena', '') }}" required>
                        ...
                        <div class="form-group {{ $errors->has('link_de_la_pagina_a') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="link_de_la_pagina_a" id="link_de_la_pagina_a" value="{{ old('link_de_la_pagina_a', '') }}">
