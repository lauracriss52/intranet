            ...
            <div class="panel panel-default">
                ...
                <ul class="nav nav-tabs" role="tablist" id="relationship-tabs">
                    <li role="presentation">
                        <a href="#dispositivo_mantenimientos" aria-controls="dispositivo_mantenimientos" role="tab" data-toggle="tab">
                            {{ trans('cruds.mantenimiento.title') }}
                        </a>
                    </li>
                </ul>
                <div class="tab-content">
                    <div class="tab-pane" role="tabpanel" id="dispositivo_mantenimientos">
                        @includeIf('admin.assets.relationships.dispositivoMantenimientos', ['mantenimientos' => $asset->dispositivoMantenimientos])
                    </div>
                </div>
            </div>
