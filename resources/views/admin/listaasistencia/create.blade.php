        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.create') }} {{ trans('cruds.listaasistencium.title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.listaasistencia.store") }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group {{ $errors->has('temas_a_tratar') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control ckeditor" name="temas_a_tratar" id="temas_a_tratar">{!! old('temas_a_tratar') !!}</textarea>
