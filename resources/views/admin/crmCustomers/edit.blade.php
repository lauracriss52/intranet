                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.crm-customers.update", [$crmCustomer->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('description') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control ckeditor" name="description" id="description">{!! old('description', $crmCustomer->description) !!}</textarea>
                        ...
                        <div class="form-group {{ $errors->has('nit') ? 'has-error' : '' }}">
                            <label for="nit">{{ trans('cruds.crmCustomer.fields.nit') }}</label>
                            <input class="form-control" type="text" name="nit" id="nit" value="{{ old('nit', $crmCustomer->nit) }}">
                            @if($errors->has('nit'))
                                <span class="help-block" role="alert">{{ $errors->first('nit') }}</span>
                            @endif
                            <span class="help-block">{{ trans('cruds.crmCustomer.fields.nit_helper') }}</span>
                        </div>
