    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.salarios.update", [$salario->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="salario">{{ trans('cruds.salario.fields.salario') }}</label>
                            <input class="form-control" type="number" name="salario" id="salario" value="{{ old('salario', $salario->salario) }}" step="0.01" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="fecha" id="fecha" value="{{ old('fecha', $salario->fecha) }}">
                            @if($errors->has('fecha'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('fecha') }}
                                </div>
