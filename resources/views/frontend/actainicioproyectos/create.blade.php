        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header">
                    {{ trans('global.create') }} {{ trans('cruds.actainicioproyecto.title_singular') }}
                </div>

                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.actainicioproyectos.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="gerente_id" id="gerente_id">
                                @foreach($gerentes as $id => $entry)
                                    <option value="{{ $id }}" {{ old('gerente_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="objetivos_objetivos" id="objetivos_objetivos">{!! old('objetivos_objetivos') !!}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="costo" id="costo" value="{{ old('costo', '') }}" step="0.01">
                            @if($errors->has('costo'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('costo') }}
                                </div>
