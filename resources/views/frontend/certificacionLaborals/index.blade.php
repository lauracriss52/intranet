        ...
        <div class="col-md-12">
            @can('certificacion_laboral_create')
                <div style="margin-bottom: 10px;" class="row">
                    <div class="col-lg-12">
                        <a class="btn btn-success" href="{{ route('frontend.certificacion-laborals.create') }}">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class=" table table-bordered table-striped table-hover datatable datatable-CertificacionLaboral">
                            <thead>
                                <tr>
                                    <th>
                                    ...
                                    <tr data-entry-id="{{ $certificacionLaboral->id }}">
                                        ...
                                        <td>
                                            @can('certificacion_laboral_show')
                                                <a class="btn btn-xs btn-primary" href="{{ route('frontend.certificacion-laborals.show', $certificacionLaboral->id) }}">
                                                    {{ trans('global.view') }}
                                                </a>
                                            @endcan

                                            @can('certificacion_laboral_edit')
                                                <a class="btn btn-xs btn-info" href="{{ route('frontend.certificacion-laborals.edit', $certificacionLaboral->id) }}">
                                                    {{ trans('global.edit') }}
                                                </a>
                                            @endcan

                                            @can('certificacion_laboral_delete')
                                                <form action="{{ route('frontend.certificacion-laborals.destroy', $certificacionLaboral->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
...
@can('certificacion_laboral_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('frontend.certificacion-laborals.massDestroy') }}",
...
@endcan
  ...
  let table = $('.datatable-CertificacionLaboral:not(.ajaxTable)').DataTable({ buttons: dtButtons })
