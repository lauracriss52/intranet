...
class ActacierreproyectoController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.actacierreproyectos.index', compact('actacierreproyectos'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.actacierreproyectos.create', compact('administradors', 'aprobados', 'contacto_area_desarrollo_proyectos', 'empresas', 'lista_interesados', 'proyectos'));
    }
    ...
    public function store(StoreActacierreproyectoRequest $request)
    {
        ...
        return redirect()->route('admin.actacierreproyectos.index');
    }
    ...
    public function edit(Actacierreproyecto $actacierreproyecto)
    {
        ...
        return view('admin.actacierreproyectos.edit', compact('actacierreproyecto', 'administradors', 'aprobados', 'contacto_area_desarrollo_proyectos', 'empresas', 'lista_interesados', 'proyectos'));
    }
    ...
    public function show(Actacierreproyecto $actacierreproyecto)
    {
        ...
        return view('admin.actacierreproyectos.show', compact('actacierreproyecto'));
    }
