...
class ActainicioproyectoController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.actainicioproyectos.index', compact('actainicioproyectos'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.actainicioproyectos.create', compact('aprobados', 'contacto_area_desarrollo_proyectos', 'empresas', 'gerentes', 'lista_interesados', 'proyectos'));
    }
    ...
    public function store(StoreActainicioproyectoRequest $request)
    {
        ...
        return redirect()->route('admin.actainicioproyectos.index');
    }
    ...
    public function edit(Actainicioproyecto $actainicioproyecto)
    {
        ...
        return view('admin.actainicioproyectos.edit', compact('actainicioproyecto', 'aprobados', 'contacto_area_desarrollo_proyectos', 'empresas', 'gerentes', 'lista_interesados', 'proyectos'));
    }
    ...
    public function show(Actainicioproyecto $actainicioproyecto)
    {
        ...
        return view('admin.actainicioproyectos.show', compact('actainicioproyecto'));
    }
