...
class SalarioController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.salarios.index', compact('salarios'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.salarios.create');
    }
    ...
    public function store(StoreSalarioRequest $request)
    {
        ...
        return redirect()->route('frontend.salarios.index');
    }
    ...
    public function edit(Salario $salario)
    {
        ...
        return view('frontend.salarios.edit', compact('salario'));
    }
    ...
    public function show(Salario $salario)
    {
        ...
        return view('frontend.salarios.show', compact('salario'));
    }
